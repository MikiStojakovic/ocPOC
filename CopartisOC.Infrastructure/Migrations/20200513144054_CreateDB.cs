    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fourisseur", x => x.FourisseurId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifiedBy = table.Column<string>(nullable: true),
                    LastModified = table.Column<DateTime>(nullable: true),
                    OcRef = table.Column<string>(maxLength: 15, nullable: false),
                    DocPath = table.Column<string>(nullable: true),
                    ModeSoumission = table.Column<int>(nullable: false),
                    TypeCompte = table.Column<string>(nullable: true),
                    OcDetails_NatureCompte = table.Column<string>(nullable: true),
                    OcDetails_TypeOuverture = table.Column<string>(nullable: true),
                    ConseillerId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OuvertureComptes", x => x.OuvertureCompteId);
                    table.ForeignKey(
